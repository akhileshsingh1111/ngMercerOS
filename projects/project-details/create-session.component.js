...
var CreateSessionComponent = (function () {
    ...
    CreateSessionComponent.prototype.ngOnInit = function () {
        ...
        this.abstract = new forms_1.FormControl('', [forms_1.Validators.required, forms_1.Validators.maxLength(100), restricted_words_validator_1.restrictedWords(['Mercer', 'OS'])]);
